...
export function registerDiscApi(client: YourClient) {
  new REST({ version: "10" })
...
export async function registerSlashCommands(client: YourClient) {
...
export async function registerEvents(client: YourClient) {
...
export async function registerButtons(client: YourClient) {
...
export async function registerModals(client: YourClient) {
...
export async function registerSelectMenus(client: YourClient) {
